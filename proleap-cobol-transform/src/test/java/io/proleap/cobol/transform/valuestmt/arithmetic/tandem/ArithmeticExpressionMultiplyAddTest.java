...
@MicronautTest
public class ArithmeticExpressionMultiplyAddTest {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/transform/valuestmt/arithmetic/tandem/ArithmeticExpressionMultiplyAdd.cbl");

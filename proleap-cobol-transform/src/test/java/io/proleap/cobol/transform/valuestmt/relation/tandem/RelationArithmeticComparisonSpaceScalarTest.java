...
@MicronautTest
public class RelationArithmeticComparisonSpaceScalarTest {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/transform/valuestmt/relation/tandem/RelationArithmeticComparisonSpaceScalar.cbl");

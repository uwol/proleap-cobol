...
@MicronautTest
public class ArithmeticExpressionDivideAddTest {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/transform/valuestmt/arithmetic/tandem/ArithmeticExpressionDivideAdd.cbl");

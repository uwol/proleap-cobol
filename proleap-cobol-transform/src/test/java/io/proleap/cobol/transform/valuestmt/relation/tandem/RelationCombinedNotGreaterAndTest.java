...
@MicronautTest
public class RelationCombinedNotGreaterAndTest {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/transform/valuestmt/relation/tandem/RelationCombinedNotGreaterAnd.cbl");

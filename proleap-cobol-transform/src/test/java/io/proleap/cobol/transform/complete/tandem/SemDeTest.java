package io.proleap.cobol.transform.complete.tandem;
...
public class SemDeTest {
	...
	public void test() throws Exception {
		final File inputFile = new File("src/test/resources/io/proleap/cobol/transform/complete/tandem/SemDe.cbl");

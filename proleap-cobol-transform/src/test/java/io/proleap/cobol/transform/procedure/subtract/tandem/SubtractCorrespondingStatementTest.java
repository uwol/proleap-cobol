...
@MicronautTest
public class SubtractCorrespondingStatementTest {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/transform/procedure/subtract/tandem/SubtractCorrespondingStatement.cbl");

package io.proleap.cobol.interpreter.procedure.subtract.fromgiving;
...
@MicronautTest
public class SubtractFromGivingStatementMultipleLiteralsTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/subtract/fromgiving/SubtractFromGivingStatementMultipleLiterals.cbl");
		...
		assertEquals(BigDecimal.valueOf(23), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
		assertEquals(BigDecimal.valueOf(20), valueService.getDecimal(getValue("SOMEID2", programUnit, state)));
		assertEquals(BigDecimal.valueOf(20), valueService.getDecimal(getValue("SOMEID3", programUnit, state)));
	}
}

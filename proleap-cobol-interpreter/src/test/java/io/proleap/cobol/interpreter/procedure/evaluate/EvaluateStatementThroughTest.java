...
@MicronautTest
public class EvaluateStatementThroughTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/evaluate/EvaluateStatementThrough.cbl");
		...
		assertEquals(BigDecimal.valueOf(44), valueService.getDecimal(getValue("SOMEAGE", programUnit, state)));
		assertEquals(BigDecimal.valueOf(2), valueService.getDecimal(getValue("SOMEID2", programUnit, state)));
	}
}

...
@MicronautTest
public class PerformProcedureTimesTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/perform/PerformProcedureTimes.cbl");
		...
		assertEquals("Paragraph perform", state.getConsole().getLines().get(1));
		assertEquals("Paragraph perform", state.getConsole().getLines().get(2));
		assertEquals("Paragraph perform", state.getConsole().getLines().get(3));

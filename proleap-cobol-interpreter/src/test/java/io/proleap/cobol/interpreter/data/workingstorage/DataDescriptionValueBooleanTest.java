...
@MicronautTest
public class DataDescriptionValueBooleanTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/data/workingstorage/DataDescriptionValueBoolean.cbl");
		...
		assertEquals(true, valueService.getBoolean(getValue("ITEMTRUE", programUnit, state)));
		assertEquals(false, valueService.getBoolean(getValue("ITEMFALSE", programUnit, state)));
	}
}

package io.proleap.cobol.interpreter.procedure.subtract.from;
...
@MicronautTest
public class SubtractFromStatementMultipleLiteralsTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/subtract/from/SubtractFromStatementMultipleLiterals.cbl");
		...
		assertEquals(BigDecimal.valueOf(39), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));

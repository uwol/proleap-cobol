...
@MicronautTest
public class SetByStatementTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/set/SetByStatement.cbl");
		...
		assertEquals(BigDecimal.valueOf(3), valueService.getDecimal(getValue("COUNTER", programUnit, state)));
	}
}

...
@MicronautTest
public class DataDescriptionValueNumericTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/data/workingstorage/DataDescriptionValueNumeric.cbl");
		...
		assertEquals(BigDecimal.valueOf(23.4), valueService.getDecimal(getValue("ITEMNUMERIC", programUnit, state)));
		assertEquals(BigDecimal.valueOf(42), valueService.getDecimal(getValue("ITEMINTEGER", programUnit, state)));
	}
}

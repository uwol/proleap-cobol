...
@MicronautTest
public class DivideIntoStatementLiteralTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/divide/into/DivideIntoStatementLiteral.cbl");

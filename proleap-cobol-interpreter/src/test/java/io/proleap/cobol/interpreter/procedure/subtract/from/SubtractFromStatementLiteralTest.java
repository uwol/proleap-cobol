...
@MicronautTest
public class SubtractFromStatementLiteralTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/subtract/from/SubtractFromStatementLiteral.cbl");
		...
		assertEquals(BigDecimal.valueOf(41), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
	}
}

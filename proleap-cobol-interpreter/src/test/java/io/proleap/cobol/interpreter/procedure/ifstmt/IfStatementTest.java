package io.proleap.cobol.interpreter.procedure.ifstmt;
...
public class IfStatementTest extends TestBase {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/ifstmt/IfStatement.cbl");
		...
		assertEquals(BigDecimal.valueOf(1000), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
		assertEquals(BigDecimal.valueOf(3), valueService.getDecimal(getValue("SOMEID2", programUnit, state)));
	}
}

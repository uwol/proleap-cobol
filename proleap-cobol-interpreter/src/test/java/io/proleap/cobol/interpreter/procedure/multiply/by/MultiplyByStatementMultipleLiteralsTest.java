package io.proleap.cobol.interpreter.procedure.multiply.by;
...
@MicronautTest
public class MultiplyByStatementMultipleLiteralsTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/multiply/by/MultiplyByStatementMultipleLiterals.cbl");
		...
		assertEquals(BigDecimal.valueOf(46), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
		assertEquals(BigDecimal.valueOf(84), valueService.getDecimal(getValue("SOMEID2", programUnit, state)));
	}
}

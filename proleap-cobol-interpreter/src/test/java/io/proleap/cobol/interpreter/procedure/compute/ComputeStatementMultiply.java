package io.proleap.cobol.interpreter.procedure.compute;
...
@MicronautTest
public class ComputeStatementMultiply extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/compute/ComputeStatementMultiply.cbl");
		...
		assertEquals(BigDecimal.valueOf(46), valueService.getDecimal(getValue("SOMEID2", programUnit, state)));
	}
}

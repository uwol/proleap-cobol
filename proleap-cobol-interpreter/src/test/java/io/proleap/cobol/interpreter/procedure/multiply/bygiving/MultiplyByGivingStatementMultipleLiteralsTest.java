package io.proleap.cobol.interpreter.procedure.multiply.bygiving;
...
@MicronautTest
public class MultiplyByGivingStatementMultipleLiteralsTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/multiply/bygiving/MultiplyByGivingStatementMultipleLiterals.cbl");
		...
		assertEquals(BigDecimal.valueOf(6), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
		assertEquals(BigDecimal.valueOf(6), valueService.getDecimal(getValue("SOMEID2", programUnit, state)));
	}
}

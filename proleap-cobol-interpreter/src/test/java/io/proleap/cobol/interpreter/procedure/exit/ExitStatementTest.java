package io.proleap.cobol.interpreter.procedure.exit;
...
@MicronautTest
public class ExitStatementTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/exit/ExitStatement.cbl");

...
@MicronautTest
public class ComputeStatementMultiplyMultipleLiterals extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/compute/ComputeStatementMultiplyMultipleLiterals.cbl");
		...
		assertEquals(BigDecimal.valueOf(4), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
	}
}

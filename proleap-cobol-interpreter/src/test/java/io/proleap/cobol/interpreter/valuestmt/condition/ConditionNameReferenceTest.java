package io.proleap.cobol.interpreter.valuestmt.condition;
...
@MicronautTest
public class ConditionNameReferenceTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/valuestmt/condition/ConditionNameReference.cbl");
		...
		assertEquals("female", state.getConsole().getLines().get(0));
	}
}

...
@MicronautTest
public class EvaluateStatementBooleanNotTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/evaluate/EvaluateStatementBooleanNot.cbl");
		...
		assertEquals(BigDecimal.valueOf(30), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
	}
}

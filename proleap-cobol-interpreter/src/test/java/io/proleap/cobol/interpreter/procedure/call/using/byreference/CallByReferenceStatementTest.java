package io.proleap.cobol.interpreter.procedure.call.using.byreference;
...
@MicronautTest
public class CallByReferenceStatementTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/call/using/byreference/CallByReferenceStatement.cbl");
		final File calledFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/call/using/byreference/Util.cbl");

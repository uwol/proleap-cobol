package io.proleap.cobol.interpreter.procedure.add.to;
...
@MicronautTest
public class AddToStatementMultipleLiteralsTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/add/to/AddToStatementMultipleLiterals.cbl");
		...
		assertEquals(BigDecimal.valueOf(5), valueService.getDecimal(getValue("TEST2", programUnit, state)));
		assertEquals(BigDecimal.valueOf(5), valueService.getDecimal(getValue("TEST3", programUnit, state)));
	}
}

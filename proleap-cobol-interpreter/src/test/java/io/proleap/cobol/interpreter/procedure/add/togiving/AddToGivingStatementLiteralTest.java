...
@MicronautTest
public class AddToGivingStatementLiteralTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/add/togiving/AddToGivingStatementLiteral.cbl");
		...
		assertEquals(BigDecimal.valueOf(3), valueService.getDecimal(getValue("TEST1", programUnit, state)));
		assertEquals(BigDecimal.valueOf(4), valueService.getDecimal(getValue("TEST2", programUnit, state)));
	}
}

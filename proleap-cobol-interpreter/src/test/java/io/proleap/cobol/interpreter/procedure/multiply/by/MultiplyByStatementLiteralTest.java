...
@MicronautTest
public class MultiplyByStatementLiteralTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/multiply/by/MultiplyByStatementLiteral.cbl");
		...
		assertEquals(BigDecimal.valueOf(20), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
	}
}

...
@MicronautTest
public class EvaluateStatementAnyTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/evaluate/EvaluateStatementAny.cbl");
		...
		assertEquals(BigDecimal.valueOf(10), valueService.getDecimal(getValue("SOMEID2", programUnit, state)));
	}
}

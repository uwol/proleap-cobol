...
@MicronautTest
public class StringStatementOverflowTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/string/StringStatementOverflow.cbl");
		...
		assertEquals("OVERFLOW!", state.getConsole().getLines().get(0));
	}
}

package io.proleap.cobol.interpreter.procedure.call.using.byvalue;
...
@MicronautTest
public class CallByValueStatementTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/call/using/byvalue/CallByValueStatement.cbl");
		final File calledFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/call/using/byvalue/Util.cbl");

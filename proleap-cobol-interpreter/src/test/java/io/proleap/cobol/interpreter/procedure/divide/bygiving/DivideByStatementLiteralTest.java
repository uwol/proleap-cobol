package io.proleap.cobol.interpreter.procedure.divide.bygiving;
...
@MicronautTest
public class DivideByStatementLiteralTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/divide/bygiving/DivideByStatementLiteral.cbl");
		...
		assertEquals(BigDecimal.valueOf(5), valueService.getDecimal(getValue("SOMEID1", programUnit, state)));
	}
}

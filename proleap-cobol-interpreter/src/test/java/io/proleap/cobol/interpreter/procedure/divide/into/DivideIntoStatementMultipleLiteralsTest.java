package io.proleap.cobol.interpreter.procedure.divide.into;
...
@MicronautTest
public class DivideIntoStatementMultipleLiteralsTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/procedure/divide/into/DivideIntoStatementMultipleLiterals.cbl");
		...
		assertEquals(BigDecimal.valueOf(5), valueService.getDecimal(getValue("SOMEID2", programUnit, state)));
	}
}

...
@MicronautTest
public class DataDescription66GroupTest extends TestBase {

	@Test
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/interpreter/data/workingstorage/DataDescription66Group.cbl");
		...
		assertEquals(" ".repeat(20), valueService.getString(getValue("ITEMS", programUnit, state)));
		assertEquals(" ".repeat(20), valueService.getString(getValue("ITEMZ", programUnit, state)));
	}
}

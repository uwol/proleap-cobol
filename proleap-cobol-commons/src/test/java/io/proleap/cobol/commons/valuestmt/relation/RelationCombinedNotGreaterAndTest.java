...
@MicronautTest
public class RelationCombinedNotGreaterAndTest extends TestBase {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/commons/util/valuestmt/relation/RelationCombinedNotGreaterAnd.cbl");
		final Program program = new CobolParserRunnerImpl().analyzeFile(inputFile, CobolSourceFormatEnum.TANDEM);

		final CompilationUnit compilationUnit = program.getCompilationUnit("RelationCombinedNotGreaterAnd");

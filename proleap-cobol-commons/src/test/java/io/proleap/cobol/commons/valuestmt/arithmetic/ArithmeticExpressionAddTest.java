...
@MicronautTest
public class ArithmeticExpressionAddTest extends TestBase {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/commons/util/valuestmt/arithmetic/ArithmeticExpressionAdd.cbl");
		final Program program = new CobolParserRunnerImpl().analyzeFile(inputFile, CobolSourceFormatEnum.TANDEM);

		final CompilationUnit compilationUnit = program.getCompilationUnit("ArithmeticExpressionAdd");

...
@Singleton
public class NotMoreThanOneSQLOperationRule extends IssueRule {

	protected final String DESCRIPTION = "Sections and paragraphs should not perform more than one SQL operation at %s";

	@Inject
	private NotMoreThanOneSQLOperationFeatureGenerator featureGenerator;

...
@Singleton
public class MoveOnlyToExistingVariablesRule extends IssueRule {

	protected final String DESCRIPTION = "MOVE TO receiving variable does not exist at %s";

	@Inject
	private MoveOnlyToExistingVariablesFeatureGenerator featureGenerator;

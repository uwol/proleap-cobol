...
@Singleton
public class SectionShouldEndWithEmptyParagraphRule extends IssueRule {

	protected final String DESCRIPTION = "Section should end with empty paragraph at %s";

	@Inject
	private SectionShouldEndWithEmptyParagraphFeatureGenerator featureGenerator;

...
@Singleton
public class IdenticalExpressionsArithmeticOperatorRule extends IssueRule {

	protected final String DESCRIPTION = "Identical expressions on both sides of the arithmetic operator at %s yield a predictable result";

	@Inject
	private IdenticalExpressionsArithmeticOperatorFeatureGenerator featureGenerator;

...
@Singleton
public class UnusedDataItemBlocksShouldBeRemovedRule extends IssueRule {

	protected final String DESCRIPTION = "Unused Data Item Blocks should be removed at %s";

	@Inject
	private UnusedDataItemBlocksShouldBeRemovedFeatureGenerator featureGenerator;

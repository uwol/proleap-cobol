...
@Singleton
public class AlterShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "\"ALTER\" should not be used at %s";

	@Inject
	private AlterShouldNotBeUsedFeatureGenerator featureGenerator;

...
@Singleton
public class PerformParagraphShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "\"PERFORM PARAGRAPH\" should not be used at %s";

	@Inject
	private PerformParagraphShouldNotBeUsedFeatureGenerator featureGenerator;

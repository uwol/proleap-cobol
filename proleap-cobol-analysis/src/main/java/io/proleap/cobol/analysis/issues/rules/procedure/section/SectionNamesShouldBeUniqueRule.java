...
@Singleton
public class SectionNamesShouldBeUniqueRule extends IssueRule {

	protected final String DESCRIPTION = "Section names should be unique within a program.";

	@Inject
	private SectionNamesShouldBeUniqueFeatureGenerator featureGenerator;

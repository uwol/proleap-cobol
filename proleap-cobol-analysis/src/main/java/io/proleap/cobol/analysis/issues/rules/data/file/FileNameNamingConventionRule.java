...
@Singleton
public class FileNameNamingConventionRule extends IssueRule {

	protected final String DESCRIPTION = "File names should comply with a naming convention at %s";

	@Inject
	private FileNameNamingConventionFeatureGenerator featureGenerator;

...
@Singleton
public class NewTypesShouldBeDefinedInCopybooksRule extends IssueRule {

	protected final String DESCRIPTION = "A TYPEDEF keyword was used at %s. It should only be used in copybooks.";

	@Inject
	private NewTypesShouldBeDefinedInCopybooksFeatureGenerator featureGenerator;

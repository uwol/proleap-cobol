...
@Singleton
public class PerformThroughLastParagraphShouldOnlyContainExitRule extends IssueRule {

	protected final String DESCRIPTION = "The last paragraph of PERFORM THROUGH at %s should only contain an EXIT statement";

	@Inject
	private PerformThroughLastParagraphShouldOnlyContainExitFeatureGenerator featureGenerator;

...
@Singleton
public class BlockContainsZeroRecordsRule extends IssueRule {

	protected final String DESCRIPTION = "\"0 RECORDS\" should be specified for \"BLOCK CONTAINS\" at %s";

	@Inject
	private BlockContainsZeroRecordsFeatureGenerator featureGenerator;

...
@Singleton
public class MergeShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "MERGE should not be used at %s";

	@Inject
	private MergeShouldNotBeUsedFeatureGenerator featureGenerator;

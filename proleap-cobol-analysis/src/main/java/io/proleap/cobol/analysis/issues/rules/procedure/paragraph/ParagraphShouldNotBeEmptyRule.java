...
@Singleton
public class ParagraphShouldNotBeEmptyRule extends IssueRule {

	protected final String DESCRIPTION = "Paragraph %s is empty";

	@Inject
	private ParagraphShouldNotBeEmptyFeatureGenerator featureGenerator;

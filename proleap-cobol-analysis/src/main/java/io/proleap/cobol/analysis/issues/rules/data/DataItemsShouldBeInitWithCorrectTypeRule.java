...
@Singleton
public class DataItemsShouldBeInitWithCorrectTypeRule extends IssueRule {

	protected final String DESCRIPTION = "The data item at %s should be initialized with the correct data type.";

	@Inject
	private DataItemsShouldBeInitWithCorrectTypeFeatureGenerator featureGenerator;

...
@Singleton
public class SortShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "SORT should not be used at %s";

	@Inject
	private SortShouldNotBeUsedFeatureGenerator featureGenerator;

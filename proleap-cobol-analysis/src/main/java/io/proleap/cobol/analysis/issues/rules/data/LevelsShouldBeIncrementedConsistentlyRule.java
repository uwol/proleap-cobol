...
@Singleton
public class LevelsShouldBeIncrementedConsistentlyRule extends IssueRule {

	protected final String DESCRIPTION = "Data item levels should be incremented consistently at %s";

	@Inject
	private LevelsShouldBeIncrementedConsistentlyFeatureGenerator featureGenerator;

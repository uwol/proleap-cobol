...
@Singleton
public class SectionEmptyRule extends IssueRule {

	protected final String DESCRIPTION = "Empty SECTION at %s";

	@Inject
	private SectionEmptyFeatureGenerator featureGenerator;

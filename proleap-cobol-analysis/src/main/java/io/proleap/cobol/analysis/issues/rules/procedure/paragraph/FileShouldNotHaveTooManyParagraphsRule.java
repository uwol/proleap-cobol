...
@Singleton
public class FileShouldNotHaveTooManyParagraphsRule extends IssueRule {

	protected final String DESCRIPTION = "The file should not have too many paragraphs.";

	@Inject
	private FileShouldNotHaveTooManyParagraphsFeatureGenerator featureGenerator;

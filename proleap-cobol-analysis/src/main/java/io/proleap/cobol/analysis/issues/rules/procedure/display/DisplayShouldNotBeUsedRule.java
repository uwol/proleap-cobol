...
@Singleton
public class DisplayShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "DISPLAY should not be used at %s";

	@Inject
	private DisplayShouldNotBeUsedFeatureGenerator featureGenerator;

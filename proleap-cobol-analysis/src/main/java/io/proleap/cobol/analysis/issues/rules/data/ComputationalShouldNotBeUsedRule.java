...
@Singleton
public class ComputationalShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "For portability reasons computational fields (except COMP-5) should not be used at %s";

	@Inject
	private ComputationalShouldNotBeUsedFeatureGenerator featureGenerator;

...
@Singleton
public class PerformCallsShouldNotBeNestedTooDeeplyRule extends IssueRule {

	protected final String DESCRIPTION = "\"PERFORM\" calls should not be nested too deeply at %s";

	@Inject
	private PerformCallsShouldNotBeNestedTooDeeplyFeatureGenerator featureGenerator;

	@Override
	public List<IssueDto> apply(final CompilationUnit compilationUnit, final CobolIdRegistry idRegistry) {
		final Stream<Statement> elements = featureGenerator.getAll(compilationUnit);

...
@Singleton
public class SectionShouldNotHaveTooManyStatementsRule extends IssueRule {

	protected final String DESCRIPTION = "Section should not have too many statements at %s";

	@Inject
	private SectionShouldNotHaveTooManyStatementsFeatureGenerator featureGenerator;

...
@Singleton
public class AcceptShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "ACCEPT should not be used at %s";

	@Inject
	private AcceptShouldNotBeUsedFeatureGenerator featureGenerator;

...
@Singleton
public class NextSentenceShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "NEXT SENTENCE should not be used at %s";

	@Inject
	private NextSentenceShouldNotBeUsedFeatureGenerator featureGenerator;

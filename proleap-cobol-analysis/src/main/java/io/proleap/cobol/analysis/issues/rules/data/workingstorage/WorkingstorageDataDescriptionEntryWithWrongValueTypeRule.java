...
@Singleton
public class WorkingstorageDataDescriptionEntryWithWrongValueTypeRule extends IssueRule {

	protected final String DESCRIPTION = "Incompatible value assigned to %s";

	@Inject
	private WorkingstorageDataDescriptionEntryWithWrongValueTypeFeatureGenerator featureGenerator;

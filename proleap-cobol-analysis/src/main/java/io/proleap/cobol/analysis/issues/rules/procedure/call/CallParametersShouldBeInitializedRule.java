...
@Singleton
public class CallParametersShouldBeInitializedRule extends IssueRule {

	protected final String DESCRIPTION = "The parameters of the CALL statement at %s should be initialized.";

	@Inject
	private CallParametersShouldBeInitializedFeatureGenerator featureGenerator;

...
@Singleton
public class GoToShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "GOTO should not be used at %s";

	@Inject
	private GoToShouldNotBeUsedFeatureGenerator featureGenerator;

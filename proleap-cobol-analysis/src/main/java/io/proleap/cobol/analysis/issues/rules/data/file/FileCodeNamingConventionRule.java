...
@Singleton
public class FileCodeNamingConventionRule extends IssueRule {

	protected final String DESCRIPTION = "File-Codes should comply with a naming convention at %s";

	@Inject
	private FileCodeNamingConventionFeatureGenerator featureGenerator;

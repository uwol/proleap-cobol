...
@Singleton
public class StatementsOnSeperateLinesRule extends IssueRule {

	protected final String DESCRIPTION = "Statements should be on seperate lines for better readability at %s.";

	@Inject
	private StatementsOnSeperateLinesFeatureGenerator featureGenerator;

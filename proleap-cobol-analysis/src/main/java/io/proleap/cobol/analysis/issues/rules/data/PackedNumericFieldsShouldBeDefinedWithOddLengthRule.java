...
@Singleton
public class PackedNumericFieldsShouldBeDefinedWithOddLengthRule extends IssueRule {

	protected final String DESCRIPTION = "Packed numeric field at %s should be defined with and odd number of digits";

	@Inject
	private PackedNumericFieldsShouldBeDefinedWithOddLengthFeatureGenerator featureGenerator;

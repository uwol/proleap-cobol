...
@Singleton
public class ReadStatementUndefinedRule extends IssueRule {

	protected final String DESCRIPTION = "\"READ\" statements should have an \"AT END\" or an \"INVALID KEY\" clause if \"FILE-STATUS\" is not defined at %s";

	@Inject
	private ReadStatementUndefinedFeatureGenerator featureGenerator;

...
@Singleton
public class UnusedParagraphRule extends IssueRule {

	protected final String DESCRIPTION = "Unused paragraphs should be removed at %s";

	@Inject
	private UnusedParagraphFeatureGenerator featureGenerator;

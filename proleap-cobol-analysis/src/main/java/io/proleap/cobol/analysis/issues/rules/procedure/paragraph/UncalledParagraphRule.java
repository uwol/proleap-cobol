...
@Singleton
public class UncalledParagraphRule extends IssueRule {

	protected final String DESCRIPTION = "Paragraph %s is uncalled";

	@Inject
	private UncalledParagraphFeatureGenerator featureGenerator;

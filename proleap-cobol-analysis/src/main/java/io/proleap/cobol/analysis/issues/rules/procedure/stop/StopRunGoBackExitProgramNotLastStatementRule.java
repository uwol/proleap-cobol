...
@Singleton
public class StopRunGoBackExitProgramNotLastStatementRule extends IssueRule {

	protected final String DESCRIPTION = "STOP RUN or GOBACK should be last statement";

	@Inject
	private StopRunGoBackExitProgramNotLastStatementFeatureGenerator featureGenerator;

...
@Singleton
public class IdenticalExpressionsLogicalRelationRule extends IssueRule {

	protected final String DESCRIPTION = "Identical expressions on both sides of the logical relation at %s yield a predictable result";

	@Inject
	private IdenticalExpressionsLogicalRelationFeatureGenerator featureGenerator;

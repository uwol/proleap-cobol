...
@Singleton
public class PerformThroughNamingConventionRule extends IssueRule {

	protected final String DESCRIPTION = "Procedures used in \"PERFORM ... THRU ...\" at %s should share a naming convention";

	@Inject
	private PerformThroughNamingConventionFeatureGenerator featureGenerator;

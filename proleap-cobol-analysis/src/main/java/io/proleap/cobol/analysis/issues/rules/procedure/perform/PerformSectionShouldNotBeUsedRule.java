...
@Singleton
public class PerformSectionShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "\"PERFORM SECTION\" should not be used at %s";

	@Inject
	private PerformSectionShouldNotBeUsedFeatureGenerator featureGenerator;

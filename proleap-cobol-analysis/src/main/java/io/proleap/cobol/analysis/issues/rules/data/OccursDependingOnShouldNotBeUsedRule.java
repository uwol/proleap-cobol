...
@Singleton
public class OccursDependingOnShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "\"OCCURS DEPENDING ON\" should not be used on data items at %s";

	@Inject
	private OccursDependingOnShouldNotBeUsedFeatureGenerator featureGenerator;

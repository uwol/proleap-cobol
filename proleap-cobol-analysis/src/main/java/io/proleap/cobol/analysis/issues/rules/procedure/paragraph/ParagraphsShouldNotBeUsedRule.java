...
@Singleton
public class ParagraphsShouldNotBeUsedRule extends IssueRule {

	protected final String DESCRIPTION = "Paragraphs should not be used at %s";

	@Inject
	private ParagraphsShouldNotBeUsedFeatureGenerator featureGenerator;

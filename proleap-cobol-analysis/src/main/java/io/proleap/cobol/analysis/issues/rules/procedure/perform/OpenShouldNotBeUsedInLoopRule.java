...
@Singleton
public class OpenShouldNotBeUsedInLoopRule extends IssueRule {

	protected final String DESCRIPTION = "OPEN should never be used inside a loop.";

	@Inject
	private OpenShouldNotBeUsedInLoopFeatureGenerator featureGenerator;

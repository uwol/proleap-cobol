...
@Singleton
public class IdenticalExpressionsAndOrConditionRule extends IssueRule {

	protected final String DESCRIPTION = "Identical expressions in both conditions at %s should be be simplified";

	@Inject
	private IdenticalExpressionsAndOrConditionFeatureGenerator featureGenerator;

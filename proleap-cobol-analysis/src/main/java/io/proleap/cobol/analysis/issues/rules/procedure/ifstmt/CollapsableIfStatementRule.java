...
@Singleton
public class CollapsableIfStatementRule extends IssueRule {

	protected final String DESCRIPTION = "Collapsible \"IF\" statements should be merged at %s";

	@Inject
	private CollapsableIfStatementFeatureGenerator featureGenerator;

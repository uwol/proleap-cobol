...
@Singleton
public class PerformThroughProcedureNotSequentialRule extends IssueRule {

	protected final String DESCRIPTION = "Procedures in PERFORM THROUGH should be sequential at %s";

	@Inject
	private PerformThroughProcedureNotSequentialFeatureGenerator featureGenerator;

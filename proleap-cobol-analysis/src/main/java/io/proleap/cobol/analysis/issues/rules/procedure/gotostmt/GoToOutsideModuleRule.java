...
@Singleton
public class GoToOutsideModuleRule extends IssueRule {

	protected final String DESCRIPTION = "GO TO should not step outside of the module at %s";

	@Inject
	private GoToOutsideModuleFeatureGenerator featureGenerator;

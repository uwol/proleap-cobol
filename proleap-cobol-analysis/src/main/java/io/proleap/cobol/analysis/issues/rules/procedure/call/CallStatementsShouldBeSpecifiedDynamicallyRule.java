...
@Singleton
public class CallStatementsShouldBeSpecifiedDynamicallyRule extends IssueRule {

	protected final String DESCRIPTION = "\"CALL\" programs should be specified dynamically at %s";

	@Inject
	private CallStatementsShouldBeSpecifiedDynamicallyFeatureGenerator featureGenerator;

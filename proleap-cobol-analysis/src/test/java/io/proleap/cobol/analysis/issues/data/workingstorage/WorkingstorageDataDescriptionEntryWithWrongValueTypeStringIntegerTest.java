...
@MicronautTest
public class WorkingstorageDataDescriptionEntryWithWrongValueTypeStringIntegerTest extends TestBase {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/analysis/issues/data/workingstorage/DataDescriptionTypeInvalidValueStringInteger.cbl");
		final Program program = new CobolParserRunnerImpl().analyzeFile(inputFile, CobolSourceFormatEnum.TANDEM);
		final CompilationUnit compilationUnit = program
				.getCompilationUnit("DataDescriptionTypeInvalidValueStringInteger");

...
@MicronautTest
public class MoveOnlyToLargeEnoughVariablesStringTest extends TestBase {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/analysis/issues/procedure/move/MoveOnlyToLargeEnoughVariablesString.cbl");
		final Program program = new CobolParserRunnerImpl().analyzeFile(inputFile, CobolSourceFormatEnum.TANDEM);
		final CompilationUnit compilationUnit = program.getCompilationUnit("MoveOnlyToLargeEnoughVariablesString");

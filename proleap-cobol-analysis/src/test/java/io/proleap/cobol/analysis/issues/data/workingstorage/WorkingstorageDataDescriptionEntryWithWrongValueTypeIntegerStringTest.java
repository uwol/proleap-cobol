...
@MicronautTest
public class WorkingstorageDataDescriptionEntryWithWrongValueTypeIntegerStringTest extends TestBase {
	...
	public void test() throws Exception {
		final File inputFile = new File(
				"src/test/resources/io/proleap/cobol/analysis/issues/data/workingstorage/DataDescriptionTypeInvalidValueIntegerString.cbl");
		final Program program = new CobolParserRunnerImpl().analyzeFile(inputFile, CobolSourceFormatEnum.TANDEM);
		final CompilationUnit compilationUnit = program
				.getCompilationUnit("DataDescriptionTypeInvalidValueIntegerString");
		...
		assertEquals("INVALIDITEM", dataDescriptionEntries.get(0).getName());
	}
}
